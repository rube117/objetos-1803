 ...
 * @author T-101
 */
public class VenCuestionario extends javax.swing.JFrame {

    JButton boton;

    /**
     * Creates new form VenCuestionario
     */
    public VenCuestionario() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(124, 234, 137));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VenCuestionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VenCuestionario().setVisible(true);
            }
        });
    }
